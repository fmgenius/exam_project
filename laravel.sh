...
# INSTALLATION OF LAMP STACK ON THE MASTER NODE
...
<VirtualHost *:80>
    ServerAdmin fmgenius@protonmail.com
    ServerName 192.168.33.52
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=genius/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=genius/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=genius01/' /var/www/html/laravel/.env
